...
function HowWeWorkPage({ onGoContact }) {
  const steps = [
    ...
    { title: "Free Consultation and Quote",
      desc:  "We schedule a no-obligation call and provide a transparent quote at the earliest." },
    { title: "Trial Project",
      desc:  "Start with a small pilot to validate quality and process fit. No commitment required." },
    { title: "Onboarding and Setup",
      desc:  "We assign a dedicated team and align on standard operating procedures." },
